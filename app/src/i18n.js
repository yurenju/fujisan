...
const dict = {
  zh: {
    ...
    mobileInstruction: '請用拇指壓住紅圈處，輕輕的傾斜手機，翻動不同時間的富士山。放開拇指，照片就停下。',
  ...
  en: {
    ...
    mobileInstruction: 'Press and hold the red circle with your thumb and gently tilt the phone to flip through Fuji across different moments. Let go, and the photo stops.',
  ...
  ja: {
    ...
    mobileInstruction: '親指で赤い丸を押さえ、スマートフォンをゆっくり傾けて、異なる時間の富士山をめくってください。指を離すと写真は止まります。',
